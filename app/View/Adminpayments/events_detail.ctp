            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3><?=h($log_arr[$events_detail->type]);?></h3>
                        <h4>イベントの概要</h4>
                        <table class="table table-bordered table-generated">
                            <tr><td class="col-xs-3 col-sm-3 col-md-3">ID</td>
                                <td class="col-xs-9 col-sm-9 col-md-9"><?=h($events_detail->id);?></td></tr>
                            <tr><td>日時</td>
                        ...
                        <?php if(($type_flg) and ($type==="charge")): ?>
                            ...
                            <table class="table table-bordered table-generated table-hover">
                                <tr data-href="/payments/adminpayments/charges/<?=$events_detail->data->object->id;?>">
                                    <td class="col-xs-3 col-sm-3 col-md-3"><?=number_format(h($events_detail->data->object->amount - $events_detail->data->object->amountRefunded))."円";?></td>
                                    <td class="col-xs-6 col-sm-6 col-md-6"><?=h($events_detail->data->object->description);?></td>
                        ...
                        <?php elseif(($type_flg) and ($type==="customer")): ?>
                            <table class="table table-bordered table-generated table-hover">
                                <tr data-href="/payments/adminpayments/customers/<?=$events_detail->data->object->id;?>">
                                    <td class="col-xs-9 col-sm-9 col-md-9"><?=h($events_detail->data->object->email);?></td>
                                    <td class="col-xs-3 col-sm-3 col-md-3"><?=h(date('Y/m/d H:i', $events_detail->created));?></td></tr>
                            </table>
                        <?php elseif(($type_flg) and ($type==="recursion")): ?>
                            ...
                            <table class="table table-bordered table-generated table-hover">
                                <tr data-href="/payments/adminpayments/recursion/<?=$events_detail->data->object->id;?>">
                                    <td class="col-xs-3 col-sm-3 col-md-3"><?=number_format(h($events_detail->data->object->amount))."円";?></td>
                                    <td class="col-xs-6 col-sm-6 col-md-6"><?=h($events_detail->data->object->description);?></td>
                                    <td class="col-xs-3 col-sm-3 col-md-3"><?=h(date('Y/m/d H:i', $events_detail->created));?></td></tr>
                            </table>
                        <?php endif; ?>
